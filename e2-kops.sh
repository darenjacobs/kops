...
export CLUSTER_NAME="fhlbny.test.k8s.local"

# Run k8s in existing VPC
export VPC_ID="vpc-4468832d"
export NETWORK_CIDR=172.31.0.0/16
export SUBNET_IDS="subnet-f929d890,subnet-96444fee,subnet-2eb59d64"
export SUBNET_CIDR="172.31.0.0/20,172.31.16.0/20,172.31.32.0/20"


# Get Availability Zones
export CLUSTER_AWS_ZONES="us-east-2a,us-east-2b,us-east-2c"
...
export S3_BUCKET="sanbox-devops-dist"
